...
export function TwoColumnIntro({
  ...
  return (
    <section className="mt-12 grid gap-6 rounded-[24px] bg-white p-6 shadow-[var(--shadow-card)] md:grid-cols-[1fr_1.6fr] md:items-center md:gap-10">
      <div className="flex flex-col items-center justify-center gap-4 text-center md:items-start md:text-left">
        <div className="relative h-36 w-36 overflow-hidden rounded-full border-4 border-[var(--nv-bg)] shadow-lg">
      ...
      <div className="rounded-[20px] bg-[var(--nv-bg)]/80 p-5 text-[var(--nv-muted)] md:p-7">
        {text}
      </div>
    </section>
  );
