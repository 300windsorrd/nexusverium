...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Founding research team: Jonathan Eleonidas Arroyo Yunda (Founder & Systems Architect), Jensy Jimenez (Lead Environmental AI Systems Engineer), John Villa, Dewansh Gupta, Fasih Ur Rehman Abbasi, and Eidan Jimenez.",
  pathname: "/team",
});
